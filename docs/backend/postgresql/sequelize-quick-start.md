...
| `db/seeders.js`      | generated       | Yes           | No              | For data migration, eg. populate database table with sample data or test data. The boilerplate for these files are generated by commands `sequelize-cli seed:generate`. These files **need to be updated manually** to reflect our data models expectation.                                                                                                                                                                                                                                 |
